...
<head>
  ...
  <title>Employee Profile | Smart Business Management</title>
  ...
  <main class="flex-1 p-8 overflow-y-auto">
    ...
    <section class="bg-white p-8 rounded-xl shadow-md max-w-3xl mx-auto">
      ...
      <div class="flex flex-col items-center space-y-4 mb-8">
        <img src="https://cdn-icons-png.flaticon.com/512/3135/3135715.png" class="w-24 h-24 rounded-full border-4 border-blue-600">
        <h2 class="text-2xl font-semibold text-gray-800">Ravi Kumar</h2>
        <p class="text-gray-500">ravi@example.com</p>
      </div>
      ...
      <form class="space-y-5">
        <div>
          ...
          <input type="text" value="Ravi Kumar"
            class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500">
        </div>
        <div>
          <label class="block text-gray-700 font-semibold mb-2">Email</label>
          <input type="email" value="ravi@example.com"
            class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500">
        </div>
        <div>
        ...
        <div class="grid md:grid-cols-2 gap-6">
          <div>
            ...
            <input type="text" value="Sales Team" readonly
          ...
          <div>
            ...
            <input type="text" value="Sales Executive" readonly
              class="w-full bg-gray-100 border border-gray-300 rounded-lg px-4 py-2">
          </div>
        </div>
